...
def detect_images(
        ...
        output_dir,  # 输出目录
        conf_thresh=0.25,  # 置信度阈值，识别字母0.25
...
if __name__ == "__main__":
    ...
    weight_model = "yolo_origin去小核C2fFasrer-PGanji_2(after_round1)_80只区分是不是"
    ...
    output_dir = "runs/local/test/realGanji（只区分是不是，ganji_train_x3，after_round1，cof0.25iou0.5）" + img_dir + "-" + weight_model + str(time.mktime(time.localtime())) + "/"
