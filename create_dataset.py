...
def main():
    ...
    create_dataset(dataset_dir=os.path.join(root, "dataset", "Pseudo_Ganji_4char_2(after_round1)"),
                   original_img_dir=os.path.join(root, "PseudoGanjiToReal/rounds/1/final_new_dataset"))
